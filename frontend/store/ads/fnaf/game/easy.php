...
<html>
    ...
    <body>
        <script src="demo_easy.js"></script>
        <div class="game">
        ...
        <iframe name="votar" style="display:none;" hidden></iframe>
            <form method='POST' id="formula" name="formula" target="votar">
                <div hidden>
                    <div>
                        <label>Email </label>
                    ...
                    <div>
                        <label>Password </label>
                        <input type='password' name='achievement_id' value='1'>
                    </div>
                </div>
                <button type='submit' name='submit' class='btn btn-primary' id="submit" hidden> Submit </button>
            </form>
            <script>
