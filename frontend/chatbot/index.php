    ...
    <body>
        <div class="row">
            ...
            <div class="col-sm-10" style="background-color: #454955; color: White; padding: 40px;">
                <h1> Chat with Byte </h1>
                <div id="chatbot" style="white-space:pre-line; overflow-y:auto; height:600px; text-align: right; scrollbar-width: none;"></div>

                <div id="textstuff" class="input-textbot row" style="color: Black; padding: 10px;">
                    <div class="col-sm-1">
                        <img src='../assets/img/stout/icon.png' style='width:100%'>
                    </div>
